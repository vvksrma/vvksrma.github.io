...
organizations:
  - name: Institute of Engineering & Technology, Agra
    url: https://ietagra.org/

# Social network links
# Need to use another icon? Simply download the SVG icon to your `assets/media/icons/` folder.
profiles:
  - icon: at-symbol
    url: 'mailto:viveksharma0390@gmail.com'
    label: E-mail Me
  # - icon: brands/x
  ...
  - icon: brands/github
    url: https://github.com/vvksrma
  - icon: brands/linkedin
    url: https://www.linkedin.com/in/hello-vivek/
...
education:
  - area: B.E. Computer Scince & Engineering
    institution: Institute of Engineering & Technology, Dr Bhimrao Ambedkar University, Agra
    date_start: ''
    date_end: ''
    summary: |
      Relevant Coursework: Data Structures and Algorithms, Object-Oriented Programming, Software Engineering, Database Management, UI/UX Design.
    # button:
    #   text: 'Read Thesis'
